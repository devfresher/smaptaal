...
//        $this->api_mode = $this->CI->config->item('api_mode');
         ...
         * edited by Ikponmwosa Marevelous
        */
        $this->test_secret_key = $this->CI->db->get_where('ini_config',array('config_key'=>'paystack_test_secret_key'))->row()->value;
        $this->test_public_key = $this->CI->db->get_where('ini_config',array('config_key'=>'paystack_test_public_key'))->row()->value;
        $this->live_secret_key = $this->CI->db->get_where('ini_config',array('config_key'=>'paystack_live_secret_key'))->row()->value;
        $this->live_public_key = $this->CI->db->get_where('ini_config',array('config_key'=>'paystack_live_public_key'))->row()->value;
        $this->api_mode = $this->CI->db->get_where('ini_config',array('config_key'=>'paystack_api_mode'))->row()->value;
    ...
    */
     ...
     * what will be sent as POST variables. Values that already exist
     * in the array will be overwritten.
     * written by Omorisiagbon Marvelous
     */
    public function add_keys($api_mode)
    {
    ...
    */
    public function ps_auto_form()
    {
        ...
        echo 'Please wait, your payment is being processed. You will be redirected to Paystack\'s website...';
