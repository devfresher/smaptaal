<?php
    ...
    $lang['paystack_api_username'] = 'Paystack API Username';
    $lang['paystack_api_password'] = 'Paystack API Password';
    $lang['paystack_api_secret'] = 'Paystack API Secret';
