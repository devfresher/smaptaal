...
<script type="text/javascript">
    ...
    $('#applicationto_userID').change(
        function(){
            var nkuz_ID=$(this).val();
            if(nkuz_ID==0){
                $('#leavecategoryID').html('<option value="0"><?=lang("leaveapply_category")?></option>');
...
url: "<?=base_url('leaveapply/leavecategoryz')?>",
