        ...
        <?php 
                ...
                ?>
                    <h5 class="page-header">
                        <a href="<?php echo base_url('systemadmin/add') ?>" class="pull-right btn btn-success text-white">
            ...
            <div class="col-sm-12">
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tbody>
                            <?php if(!empty($systemadmins)) {$i = 1; foreach($systemadmins as $systemadmin) { if($systemadmin->systemadminID != 1 && $this->session->userdata('loginuserID') != $systemadmin->systemadminID) { ?>
                                <tr>
