                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item" style="background-color: #FFF">
                                ...
                                <b><?=$this->lang->line('mark_classes')?></b> <a class="pull-right"><?=($class) ? $class->classes : ''?></a>

                            </li>

                            <li class="list-group-item" style="background-color: #FFF">

                                <b><?=$this->lang->line('mark_section')?></b> <a class="pull-right"><?=($section) ? $section->section : ''?></a>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="active tab-pane" id="mark">
                            ...
                            $subjectCount = count($mandatorysubjects);
                                ...
                                if(!empty($profile->sroptionalsubjectID)) {
