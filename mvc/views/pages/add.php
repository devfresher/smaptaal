            ...
            <aside class="page--right--sidebar">
                ...
                <div class="bg-white mb-15">
                    ...
                    <div class="sidebar-body" id="featuredimage-box">
                        ...
                        <span class="featured-image-btn <?=($send_featured_image) ? 'hide' : ''?>" data-toggle="modal" data-target="#SetFeaturedImage" id="set-featured-img"><?=$this->lang->line('pages_set_featured_image')?></span>
