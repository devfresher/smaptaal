            ...
            <div class="areaTop">
                ...
                <div class="studentProfile">
                    ...
                    <div class="singleItem">
                        ...
                        <div class="single_value">: <?=($classes) ? $classes->classes : ''?></div>
                    </div>
                    <div class="singleItem">
                        <div class="single_label"><?=$this->lang->line('hmember_section')?></div>
                        <div class="single_value">: <?=($section) ? $section->section : ''?></div>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="70%"><?=($hostel) ? $hostel->name : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_htype")?></th>
                            <td width="70%"><?=($hostel) ? $hostel->htype : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_class_type")?></th>
                            <td width="70%"><?=($category) ? $category->class_type : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_tfee")?></th>
                            <td width="70%"><?=($hmember) ? $hmember->hbalance : 'N/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_hostel_address")?></th>
                            <td width="70%"><?=($hostel) ? $hostel->address : 'N/A' ?></td>
                        </tr>
                        <tr>
