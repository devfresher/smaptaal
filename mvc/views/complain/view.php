                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <?php } elseif($user->usertypeID == 3) { ?>
                                ...
                                <li class="list-group-item" style="background-color: #FFF">
                                    <b><?=$this->lang->line('complain_class')?></b> <a class="pull-right"><?=($classes) ? $classes->classes : ''?></a>
                                </li>
                                <li class="list-group-item" style="background-color: #FFF">
                                    <b><?=$this->lang->line('complain_section')?></b> <a class="pull-right"><?=($section) ? $section->section : ''?></a>
                                </li>
                            <?php } else { ?>
                                <li class="list-group-item" style="background-color: #FFF">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <div class="single_box">
                            ...
                            <p class="text-muted"><?=($createinfo) ? $createinfo->name : '';?></p>
                        </div>
                        <div class="single_box">
                            <strong><?=$this->lang->line('complain_complainer_role');?></strong>
                            <p class="text-muted"><?=($createinfo) ? $createinfo->usertype : '' ?></p>
                        </div>
                    </div>
                </div>
            </div>
