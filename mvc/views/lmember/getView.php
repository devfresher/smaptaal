                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('lmember_classes')?></b> <a class="pull-right"><?=($classes) ? $classes->classes : ''?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('menu_section')?></b> <a class="pull-right"><?=($section) ? $section->section : ''?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="active tab-pane" id="profile">
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("lmember_lID")?> </span>: <?=($lmember) ? $lmember->lID : 'N/A'?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("lmember_lfee")?> </span>: <?=($lmember) ? $lmember->lbalance : 'N/A'?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("lmember_joindate")?> </span>: <?=($lmember) ? date("d M Y", strtotime($lmember->ljoindate)) : 'N/A'?></p>
                                    </div>
                                    <div class="profile-view-tab">
