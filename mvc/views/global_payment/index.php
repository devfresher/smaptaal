                            ...
                            <table class="table table-striped table-bordered" style="margin-top: 10px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-control" id="invoicenumber" type="text" name="invoicenumber" value="INV-G-<?=(count((array)$globalpayment_max) > 0) ? $globalpayment_max->globalpaymentID+1 : '1'?>" readonly></td>
                        ...
                        <div class="assign-fee-payment">
                            ...
                            <table class="table info">
                                ...
                                <tr>
                                    ...
                                    <td><b><?=$this->lang->line('global_name')?>: </b><?=($single_student) ? $single_student->srname : ''?> </td>

                                    <td><b><?=$this->lang->line('global_classes')?>: </b><?=($single_classes) ? $single_classes->classes : ''?>, <b><?=$this->lang->line('global_roll')?>: </b><?=($single_student) ? $single_student->srroll : ''?>, <b><?=$this->lang->line('global_section')?>: </b><?=($single_section) ? $single_section->section : ''?></td>

                                    <td><b><?=$this->lang->line('global_group')?>: </b><?=($single_group) ? $single_group->group : ''?></td>
