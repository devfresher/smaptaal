...
<div class="row">
    ...
    <div class="col-sm-12" style="margin:10px 0px">
        ...
        <?php
             ...
             if(is_array($onlineExamUserStatus)) 
               
             $onlineExamUserStatusID=count($onlineExamUserStatus) ? $onlineExamUserStatus->onlineExamUserStatus : 0; $onlineExamUserStatusID=1;
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <span class="text-blue">
                                                ...
                                                <?=$this->lang->line('onlineexamreport_exam')?> : <?=($onlineexam) ? $onlineexam->name : ''?>
...
<script type="text/javascript">
    ...
    $('#send_pdf').click(function() {
        ...
        var field = {
            ...
            'id'        : "<?=($onlineExamUserStatus) ? $onlineExamUserStatus->onlineExamUserStatus : 0;?>",
