            ...
            <div class="row">
                ...
                <div class="col-sm-6 pull-left">
                    <div class="box box-solid classinfo">
                        ...
                        <div class="box-body">
                            <span><?=$this->lang->line("classesreport_class_number_of_students")?> : <?=($students)?></span><br>
                            <span><?=$this->lang->line("classesreport_class_total_subject_assigned")?> : <?=($subjects)?></span>
                        </div>
                    </div>
