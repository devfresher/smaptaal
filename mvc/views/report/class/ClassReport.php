                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="box box-solid " style="border: 1px #ccc solid; border-left: 2px black solid">
                            ...
                            <div class="box-body">
                                ...
                                <h5><span class='text-blue'><?=$this->lang->line("classesreport_class_number_of_students")?> : <?php
                               
                               $no_students = count($students);
                               echo  $no_students;
                                ?></span><br>

                                <span class='text-blue'><?=$this->lang->line("classesreport_class_total_subject_assigned")?> : <?php
                                
;                               $no_subjects = count($subjects);
                                echo  $no_subjects;
                                ?></span></h5>
