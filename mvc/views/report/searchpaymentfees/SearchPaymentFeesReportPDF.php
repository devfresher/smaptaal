            ...
            <div class="gbody">
                ...
                <?php if(!empty($globalpayments)) { ?>
                    ...
                    <table class="global-tableinfo">
                        <tr>
                            <td><b><?=$this->lang->line('searchpaymentfeesreport_invoice_number')?> : </b>INV-G-<?=($globalpayments) ? $globalpayments[0]->globalpaymentID : ''?></td>
                            <td><b><?=$this->lang->line('searchpaymentfeesreport_clearance')?> : </b><?=($globalpayments) ? $globalpayments[0]->clearancetype : '' ?></td>
                            <td><b><?=$this->lang->line('searchpaymentfeesreport_date')?> : </b> <?=($globalpayments) ? date('d M Y', strtotime($globalpayments[0]->paymentdate)) : '' ?></td>
                        </tr>
                        <tr>
                            <td><b><?=$this->lang->line('searchpaymentfeesreport_name')?> : </b> <?=($studentinfo) ? $studentinfo->srname : ''?></td>

                            <td><b><?=$this->lang->line('searchpaymentfeesreport_classes')?> : </b> <?=($studentinfo) ? $studentinfo->srclasses  : ''?>, <b><?=$this->lang->line('searchpaymentfeesreport_roll')?> : </b> <?=($studentinfo) ? $studentinfo->srroll : ''?>, <b><?=$this->lang->line('searchpaymentfeesreport_section')?> : </b><?=($studentinfo) ? $studentinfo->srsection  : ''?></td>
                            <td><b><?=$this->lang->line('searchpaymentfeesreport_group')?> : </b><?=($groups[$studentinfo->srstudentgroupID]) ? $groups[$studentinfo->srstudentgroupID] : '' ?></td>
                        </tr>
                        <tr>
