...
<head>
    ...
    <link href="<?php echo base_url('assets/limpids/install.css'); ?>" rel="stylesheet">
...
<script type="text/javascript" src="<?php echo base_url('assets/limpids/limpids.js'); ?>"></script>
