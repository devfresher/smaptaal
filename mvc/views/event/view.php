    ...
    <section class="panel">
        ...
        <div class="text-center">
          <div class="btn-group">
              ...
              <button style="background-color:#0A75AF" class="btn btn-facebook" data-toggle="modal" data-target="#goings" type="button"><?=($goings)?></button>
          </div>
          <div class="btn-group">
              <button style="background-color:#B00303" class="btn btn-bitbucket" data-toggle="modal" data-target="#ignores"  type="button"><?=($ignores)?></button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><?=$this->lang->line('going')?> (<?=($goings)?>)</h4>
        </div>
...
<div class="modal fade" id="ignores">
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title"><?=$this->lang->line('ignore')?> (<?=($ignores)?>)</h4>
        </div>
        <div class="modal-body">
          <table class="table table-bordered">
            <thead>
