                ...
                <div class="col-sm-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="<?php if($paystack == 1) echo 'active'; ?>"><a data-toggle="tab" href="#paystack" aria-expanded="true"><?=$this->lang->line('tab_paystack')?></a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="paystack" class="tab-pane <?php if($paystack == 1) echo 'active';?> ">
                            <br>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                            ...
                                            ?>
                                                <label for="paypal_api_username" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("paystack_api_username")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-5">
                                                    <input type="text" class="form-control" id="paypal_api_username" name="paypal_api_username" value="<?=set_value('paystack_api_username', $set_key['paystack_api_username'])?>" >
                                                </div>
                                                <span class="col-sm-4 control-label">
                                            ...
                                            ?>
                                                <label for="paypal_api_password" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("paystack_api_password")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-5">
                                            ...
                                            ?>
                                                <label for="paypal_api_signature" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("paystack_api_secret")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-5">
