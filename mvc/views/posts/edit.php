            ...
            <aside class="page--right--sidebar">
                ...
                <div class="bg-white mb-15">
                    ...
                    <div class="sidebar-body" id="featuredimage-box">
                        <div class="feauret-img-show" <?php (!empty($send_featured_image) ? 'data-toggle="modal" data-target="#SetFeaturedImage"' : ''); ?> >
                            <?php
                        ...
                        <span class="featured-image-btn <?php (!empty($send_featured_image) ? 'hide' : ''); ?>" data-toggle="modal" data-target="#SetFeaturedImage" id="set-featured-img"><?=$this->lang->line('posts_set_featured_image')?></span>
                        <span class="featured-image-btn <?php (empty($send_featured_image) ? 'hide' : ''); ?>" onclick="removeFeatureImage(this, 'featured_image', 'feauret-img-show')"  id="remove-set-featured-img"><?=$this->lang->line('posts_remove_featured_image')?></span>
                    </div>
                </div>
