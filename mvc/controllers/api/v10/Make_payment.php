    ...
    public function view_get($id= null) {
        if(permissionChecker('make_payment')) {
            ...
            if((int)$id) {
                ...
                if($this->retdata['make_payment'] != NULL) {
                    ...
                    if((int)$userID && (int) $usertypeID) {
                        ...
                        if($user != NULL) {
                            ...
                            if($manageSalary != NULL) {
                                ...
                                if($this->retdata['persent_salary_template'] != NULL) {
                                    if($this->retdata['make_payment']->salaryID == 1) {
                                        ...
                                        if($this->retdata['salary_template'] != NULL) {
                                            ...
                                            if($this->retdata['salaryoptions'] != NULL) {
                                        ...
                                        if($this->retdata['hourly_salary'] != NULL) {
