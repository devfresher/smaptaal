	...
	public function add() {
		...
		if($_POST) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$exist=$this->section_m->validate_sec($id,$section,$category);
				if($exist==null){
					$status=	$this->section_m->insert_section($array);
					if($status=='TRUE'){
					...
					$this->session->set_flashdata("failed","Session already exists" );
			...
			//logic by engineer Olekamma Kingsley Uche
