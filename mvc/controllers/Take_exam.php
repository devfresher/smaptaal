    ...
    public function show() {
        $this->data['headerassets'] = array(
            'css' => array(
                ...
                'assets/limpids/form/fuelux.min.css'
            )
        );
        $this->data['footerassets'] = array(
            'js' => array(
                'assets/limpids/form/fuelux.min.js'
            )
        );
            ...
            if(!empty($onlineExam)) {
                ...
                if($_POST) {
                    ...
                    $this->online_exam_user_status_m->insert([
                        ...
                        'score' => $correctAnswer,
                        'userID' => $userID,
                        'classesID' => !empty($this->data['class']) ? $this->data['class']->classesID : 0,
                        'sectionID' => !empty($this->data['section']) ? $this->data['section']->sectionID : 0,
